public class DoublyLinkedListTest {
	...
	public static void testPrintEmptyListForward() {
	    ...
	    System.out.print("Printing an empty Doubly Linked List forward: ");
	    list.print();
	}
	...
	public static void testPrintEmptyListBackward() {
		//TODO
		DoublyLinkedList<String> list = new DoublyLinkedList<>();
	    System.out.print("Printing an empty Doubly Linked List backward: ");
	    list.printBackwards();
	}
   ...
   public static void testRemoveFromListWithThreeElementPositive() {
	...
	public static void testAddLastBackwards() {
	 ...
	 public static void testIterator() {
		...
		for(int iterator = 0; iterator < list.getLength(); iterator++) {
